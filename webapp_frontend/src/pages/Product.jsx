                ...
                <div className="row">
                    ...
                    <div className="col-4 sticky-details">
                        ...
                        <ul className='list-unstyled mt-2'>
                            <li><i class="bi bi-box-seam"></i> Pacco 100% anonimo</li>
                            <li><i class="bi bi-check2-square"></i> Garanzia su prodotto di 2 anni</li>
                            <li><i class="bi bi-tree"></i> Materiali certificati</li>
                            <li><i class="bi bi-shield-lock"></i> Pagamento sicuro</li>
                        </ul>
